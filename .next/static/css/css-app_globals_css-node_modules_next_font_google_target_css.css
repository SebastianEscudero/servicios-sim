...
::backdrop{
  ...
  .border-\[\#837D7C\]{
  --tw-border-opacity: 1;
  border-color: rgb(131 125 124 / var(--tw-border-opacity));
}
  .border-black{
  --tw-border-opacity: 1;
  ...
  .bg-\[\#F16F0F\]{
  --tw-bg-opacity: 1;
  background-color: rgb(241 111 15 / var(--tw-bg-opacity));
}
  .bg-\[\#FFF\]{
  --tw-bg-opacity: 1;
  ...
  .bg-custom-blue{
  --tw-bg-opacity: 1;
  background-color: rgb(46 77 230 / var(--tw-bg-opacity));
}
  .bg-destructive{
  ...
  .text-custom-blue{
  --tw-text-opacity: 1;
  color: rgb(46 77 230 / var(--tw-text-opacity));
}
  ...
  .shadow-custom-1{
  --tw-shadow: 0px 1px 2px rgba(0, 0, 0, 0.25), 0px 1px 3px rgba(0, 0, 0, 0.09);
  --tw-shadow-colored: 0px 1px 2px var(--tw-shadow-color), 0px 1px 3px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
  .shadow-custom-3{
  --tw-shadow: 0px 1px 2px rgba(0, 0, 0, 0.28), 0px 2px 6px rgba(0, 0, 0, 0.14), inset 0px 0px 0px 1px rgba(255, 255, 255, 0.1);
  --tw-shadow-colored: 0px 1px 2px var(--tw-shadow-color), 0px 2px 6px var(--tw-shadow-color), inset 0px 0px 0px 1px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
  .shadow-lg{
  ...
  --tw-bg-opacity: 1;
  background-color: rgb(28 60 182 / var(--tw-bg-opacity));
}
